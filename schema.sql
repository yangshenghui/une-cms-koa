...
DROP TABLE IF EXISTS une_vedio;
CREATE TABLE une_vedio
(
    id          int(11)     NOT NULL AUTO_INCREMENT,
    title       varchar(50) NOT NULL,
    author      varchar(30)          DEFAULT NULL,
...
IF
	EXISTS une_order;
CREATE TABLE une_order (
	id INT ( 11 ) NOT NULL AUTO_INCREMENT,
	out_trade_no VARCHAR ( 32 ) NOT NULL,
	time_expire VARCHAR ( 64 ) NOT NULL,
	total INT ( 11 ) NOT NULL,
	currency VARCHAR ( 6 ) NOT NULL,
	openid VARCHAR ( 128 ) NOT NULL,
	payer_client_ip VARCHAR ( 45 ) NOT NULL,
	create_time datetime ( 3 ) NOT NULL DEFAULT CURRENT_TIMESTAMP ( 3 ),
	update_time datetime ( 3 ) NOT NULL DEFAULT CURRENT_TIMESTAMP ( 3 ) ON UPDATE CURRENT_TIMESTAMP ( 3 ),
	delete_time datetime ( 3 ) DEFAULT NULL,
PRIMARY KEY ( id ) 
...
DROP TABLE
IF
	EXISTS une_order_notice;
CREATE TABLE une_order_notice (
	id INT ( 11 ) NOT NULL AUTO_INCREMENT,
	out_trade_no VARCHAR ( 32 ) NOT NULL,
	transaction_id VARCHAR ( 32 ) DEFAULT NULL,
	trade_type VARCHAR ( 6 ) DEFAULT NULL,
	trade_state VARCHAR ( 32 ) NOT NULL,
	trade_state_desc VARCHAR ( 256 ) NOT NULL,
	success_time VARCHAR ( 64 ) DEFAULT NULL,
	openid VARCHAR ( 128 ) DEFAULT NULL,
	total INT ( 11 ) DEFAULT NULL,
	payer_total INT ( 11 ) DEFAULT NULL,
